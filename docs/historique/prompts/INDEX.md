# Index des journaux de prompts

Un fichier par **conversation** Cursor. Incrémenter à **chaque** message utilisateur.

| Slug | Titre | Dernier P | Fichier |
|------|-------|-----------|---------|
| invitations-droits-iles | Invitations & droits îles | P004 | [invitations-droits-iles.md](invitations-droits-iles.md) |
