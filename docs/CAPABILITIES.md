...
| Invitations / droits | `/pw invite\|kick\|role\|list\|visit\|leave` ; cibles **online ou offline** (GameProfile) |
...
| Version | Notes |
|----------|--------|
| 1.4.0-alpha.3 | Kick/visit/invite/role offline (GameProfile) |
