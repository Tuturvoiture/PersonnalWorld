...
| Invitations / droits | `/pw invite\|kick\|role\|list\|visit\|leave` ; offline via GameProfile (cache / UUID) |
...
| Version | Notes |
|----------|--------|
| 1.4.0-alpha.1 | DA 0.1.2 ; sync kick/TEMP ; offline kick/visit/invite/role |
